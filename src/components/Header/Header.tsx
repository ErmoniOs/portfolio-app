...
<>
        ...
        <div className="m-auto grid grid-cols-1 place-content-center bg-slate-800" style={{position: 'relative', width: "1200px", height: "500px" }}>
            ...
            {/* Circle Image */}
            <div className="bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 rounded-full pl-11 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] shadow-blue-500/20" style={{position: 'absolute', right:0, top:20, width: "500px", height: "480px" }}>
            </div>
